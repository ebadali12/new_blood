        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (emailValidator(email.getText().toString())) {
                    ...
                    if(validCellPhone(phone.getText().toString())==false){
                        phone.setError("Wrong phone# format type");
                        Toasty.error(BCsignupActivity.this, "Wrong Phone type", Toast.LENGTH_LONG, true).show();
                    }



                    else if ((filePath != null) && fieldsOK) {

                       // Toast.makeText(BCsignupActivity.this,"filepath loop",Toast.LENGTH_LONG).show();
                        ...
                        Toasty.error(BCsignupActivity.this, "Some of the fields are missing", Toast.LENGTH_LONG, true).show();
    ...
    * */
    public void uploadMultipart() {
        ...
        try {
            ...
            Toasty.error(BCsignupActivity.this,exc.getMessage(), Toast.LENGTH_LONG, true).show();
        }
    }
    ...
    protected void onPostExecute(String s) {
      ...
      pd.dismiss();
        if (s!=null)
        {
            ...
            Toasty.success(c,"Succefully registered", Toast.LENGTH_LONG, true).show();
        ...
        }else
        {
            ...
            Toasty.error(c,"Unable to download data", Toast.LENGTH_LONG, true).show();
